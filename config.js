...
export const cfg = {
  ...
  VERSION: "0.2.0", // code version number

  // Game constants
  GAME_SPEED: 1, // 1=normal 2=faster
  width: 800, // canvas width (default)
  height: 600, // canvas height (default)
  seed: 1234, // default value for seed used with custom RNG
...
// Default seeded RNG instance
export const rngInstance = seededRandomGenerator(cfg.seed);
