...
describe('Game - Fixed Tests', () => {
    ...
    describe('displayGameOver', () => {
        test('should update UI elements with game over message and scores', () => {
            ...
            expect(document.getElementById('playerGold').textContent).toBe(
                'Player Gold: 75',
            );
            expect(document.getElementById('computerGold').textContent).toBe(
                'Computer Gold: 25',
            );
            expect(document.getElementById('gameOverlay').style.display).toBe(
                'flex',
            );
            expect(document.getElementById('restartButton').textContent).toBe(
                'Play',
            );
        });
    });
